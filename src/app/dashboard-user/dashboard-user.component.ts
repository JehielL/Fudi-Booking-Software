...
export class DashboardUserComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.activatedRoute.params.subscribe(params => {
      const id = params['id'];
      if (!id) return;
      this.httpClient.get<User>('https://tell-dl-suffering-understood.trycloudflare.com/user/' + id).subscribe(userbacken => {
  ...
  save(): void {
    ...
    const url = 'https://tell-dl-suffering-understood.trycloudflare.com/user/' + user.id;
