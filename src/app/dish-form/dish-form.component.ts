...
export class DishFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.activatedRoute.params.subscribe(params => {
      ...
      this.httpClient.get<Menu>('https://tell-dl-suffering-understood.trycloudflare.com/menus/' + id)
      .subscribe(menus => {
        this.menu = menus;
      ...
      this.httpClient.get<Dish>('https://tell-dl-suffering-understood.trycloudflare.com/dishes/' + id).subscribe(dish => {
        this.dishForm.reset({
          menu: dish.menu,
        });  
        this.dish = dish;
  ...
  save() {
    ...
    if (this.isUpdate) {
      this.httpClient.put<Dish>('https://tell-dl-suffering-understood.trycloudflare.com/dishes/' + this.dish?.id, formData)
        .subscribe(dish => this.navigateToList());
    } else {
      this.httpClient.post<Dish>('https://tell-dl-suffering-understood.trycloudflare.com/dishes', formData)
        .subscribe(dish => this.navigateToList());
    }
  }
