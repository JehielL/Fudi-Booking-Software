...
export class DishFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.activatedRoute.params.subscribe(params => {
      ...
      this.httpClient.get<Menu>('https://gore-metabolism-engine-effects.trycloudflare.com/menus/' + id)
      .subscribe(menus => {
        this.menu = menus;
      ...
      this.httpClient.get<Dish>('https://gore-metabolism-engine-effects.trycloudflare.com/dishes/' + id).subscribe(dish => {
        this.dishForm.reset({
          menu: dish.menu,
        });  
        this.dish = dish;
  ...
  save() {
    ...
    if (this.isUpdate) {
      this.httpClient.put<Dish>('https://gore-metabolism-engine-effects.trycloudflare.com/dishes/' + this.dish?.id, formData)
        .subscribe(dish => this.navigateToList());
    } else {
      this.httpClient.post<Dish>('https://gore-metabolism-engine-effects.trycloudflare.com/dishes', formData)
        .subscribe(dish => this.navigateToList());
    }
  }
