...
export class DishFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.activatedRoute.params.subscribe(params => {
      ...
      this.httpClient.get<Menu>('https://217.160.163.48:8080/menus/' + id)
      .subscribe(menus => {
        this.menu = menus;
      ...
      this.httpClient.get<Dish>('https://217.160.163.48:8080/dishes/' + id).subscribe(dish => {
        this.dishForm.reset({
          menu: dish.menu,
        });  
        this.dish = dish;
  ...
  save() {
    ...
    if (this.isUpdate) {
      this.httpClient.put<Dish>('https://217.160.163.48:8080/dishes/' + this.dish?.id, formData)
        .subscribe(dish => this.navigateToList());
    } else {
      this.httpClient.post<Dish>('https://217.160.163.48:8080/dishes', formData)
        .subscribe(dish => this.navigateToList());
    }
  }
