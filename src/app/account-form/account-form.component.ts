...
export class AccountFormComponent implements OnInit {
  ...
  save() {
    ...
    if (this.photoFile) {
      ...
      this.httpClient.put<User>('https://tell-dl-suffering-understood.trycloudflare.com/users/account', this.user)
  ...
  updateProfile() {
    ...
    const url = 'https://tell-dl-suffering-understood.trycloudflare.com/users/account/avatar';
