...
export class AccountFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    timer(500).pipe(
      switchMap(() => this.httpClient.get<User>('https://217.160.163.48:8080/users/account'))
    ).subscribe(user => {
      this.user = user;
  ...
  save() {
    ...
    if (this.photoFile) {
      ...
      this.httpClient.put<User>('https://217.160.163.48:8080/users/account', this.user)
  ...
  updateProfile() {
    ...
    const url = 'https://217.160.163.48:8080/users/account/avatar';
