...
export class AccountFormComponent implements OnInit {
  ...
  save() {
    ...
    if (this.photoFile) {
      ...
      this.httpClient.put<User>('https://gore-metabolism-engine-effects.trycloudflare.com/users/account', this.user)
  ...
  updateProfile() {
    ...
    const url = 'https://gore-metabolism-engine-effects.trycloudflare.com/users/account/avatar';
