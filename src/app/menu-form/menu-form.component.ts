...
export class MenuFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.activatedRoute.params.subscribe(params => {
      ...
      const restaurantUrl = 'https://biteapp.store:8080/restaurant/' + id;

      this.httpClient.get<Restaurant>('https://biteapp.store:8080/restaurant/' + id)
      ...
      this.httpClient.get<Menu>('https://biteapp.store:8080/menus/' + id).subscribe(menu => {
  ...
  save() {
    ...
    if (this.isUpdate) {
      ...
      this.httpClient.put<Menu>('https://biteapp.store:8080/menus/' + menu.id, formData)
        .subscribe(menu => this.navigateToList());
    } else {
      this.httpClient.post<Menu>('https://biteapp.store:8080/menus', formData)
        .subscribe(menu => this.navigateToList());
    }
  }
