...
export class MenuFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.activatedRoute.params.subscribe(params => {
      ...
      this.httpClient.get<Restaurant>('https://tell-dl-suffering-understood.trycloudflare.com/restaurant/' + id)
      ...
      this.httpClient.get<Menu>('https://tell-dl-suffering-understood.trycloudflare.com/menus/' + id).subscribe(menu => {
  ...
  save() {
    ...
    if (this.isUpdate) {
      ...
      this.httpClient.put<Menu>('https://tell-dl-suffering-understood.trycloudflare.com/menus/' + menu.id, formData)
        .subscribe(menu => this.navigateToList());
    } else {
      this.httpClient.post<Menu>('https://tell-dl-suffering-understood.trycloudflare.com/menus', formData)
        .subscribe(menu => this.navigateToList());
    }
  }
